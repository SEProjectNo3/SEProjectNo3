         ...
         <div class="col-sm-8">
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-heading">
                  1단원&nbsp;<a href="evaluation-add.jsp" class="btn btn-default">진단 평가 추가</a>
               </div>

               <ul class="list-group">
                  <li class="list-group-item">사용 사례&nbsp;<a
                     href="quiz-add.jsp" class="btn btn-default">퀴즈 추가</a></li>
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  2단원&nbsp;<a href="evaluation-add.jsp" class="btn btn-default">진단평가 추가</a>
               </div>
               <!-- List group -->
               <ul class="list-group">

                  <li class="list-group-item"><a href="studying.jsp">객체지향개념(1)사용사례&nbsp;</a>
                     <a href="quiz-add.jsp" class="btn btn-default">퀴즈
                        추가</a></li>
                  ...
                  <a href="quiz-add.jsp" class="btn btn-default">퀴즈 추가</a>
                  </li>
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  3단원&nbsp;<a href="evaluation-add.jsp" class="btn btn-default">진단 평가 추가</a>
               </div>
