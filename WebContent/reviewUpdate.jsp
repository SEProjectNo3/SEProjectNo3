      ...
      <div class="row-fluid">
         ...
         <div class="col-sm-8">
           ...
           <form action="Review.do" method="post">
					<input type="hidden" name="cmd" value="review_modify_proc"> 
					<input type="hidden" name="rId" value="<%=request.getParameter("reviewId")%>">
					<input
						class="star" type="radio" name="rate" value="1" /> <input
						class="star" type="radio" name="rate" value="2" /> <input
						class="star" type="radio" name="rate" value="3" /> <input
						class="star" type="radio" name="rate" value="4" /> <input
						class="star" type="radio" name="rate" value="5" />
